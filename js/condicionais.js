...
console.log(`Esta comparação é: ${a === b}, ou seja ${a} = ${b}!`)//? Estamos fazendo comparação com três iguais, ou seja, comparação de valores e tipo
console.log(`Esta comparação é: ${a === c}, ou seja ${a} != ${c}!`)//? Estamos fazendo comparação com três iguais, ou seja, comparação de valores e tipo